...
flowchart TB
    ...
    BAY["**BayEUG** · Bay. Erziehungs- und Unterrichts-Gesetz<br/>Art. 56/4 (SuS-Verhaltenspflicht — verified-1:1) · Art. 86 (Erziehungs-/Ordnungs-Maßnahmen — partial-summary) · Art. 87 (Sicherungs-Ausschluss — Anker) · Art. 88 (Verfahren — Anker) · Art. 57 (SL-Gesamtverantwortung — Anker) · Art. 75 (Unterrichtungspflicht EB — Anker)"]:::bay
    VO["**BaySchO + LDO** · Verordnungen<br/>BaySchO § 23/1 (Konsumverbot) · § 23/2 (Wegnahme/Sicherstellung — verified-1:1) · LDO § 5 (Aufsicht — verified-1:1, VERWEIS MP_06)"]:::vo
    BUND["**Bundesrecht** · § 241 StGB (Bedrohung — Anker) · § 224 StGB (gef. KV — Anker) · § 138 StGB (Anzeigepflicht — Anker) · § 8a SGB VIII (Kindeswohlgefährdung — Anker) · § 1 JGG (Strafmündigkeit ab 14)"]:::bund
    NEBEN["**WaffG / BayPolG** · Waffenrechtliche Mitführungsverbote (Anker, marginal) · Polizei-Verständigung in Eilfällen"]:::vo
...
| **BayEUG** | Art. 56/4 (SuS-Verhaltenspflicht — verified-1:1) · Art. 86 (Erziehungs-/Ordnungsmaßnahmen — partial-summary, Abs. 1+3 verbatim, Abs. 2 12-Punkte-Katalog Punkte 4-12 summarisch) · **Art. 87** (Sicherungs-Ausschluss vorläufig — *out-of-repo Anker*) · **Art. 88** (Verfahren mit Anhörung — *out-of-repo Anker*) · Art. 57 (SL-Gesamtverantwortung — *out-of-repo Anker*) · Art. 75 (EB-Unterrichtung — *out-of-repo Anker*) |
| **VO** | **BaySchO § 23/1** (Konsumverbot Alkohol/Rauschmittel — verified-1:1) · **§ 23/2** (Mitführen/Wegnahme/Rückgabe — verified-1:1) · **LDO § 5** (Aufsicht — verified-1:1, VERWEIS MP_06) |
...
!!! abstract "Begleit-Material"
    - 🃏 [**Anki-Lerndeck** (24 Karten · 10 Falle · 4 Hochprior)](https://weitergehts.online/lerndecks/schulrecht-mp01-messer-im-unterricht/)
    - 📑 [**Themen-Übersichtsseite**](https://weitergehts.online/staatsexamen/schulrecht/1-messer-im-unterricht/)
...
```mermaid
flowchart LR
    EVT["**Sachverhalt**<br/>SuS bedroht Mitschüler mit Messer"]:::root
    GA["**Gefahrenabwehr** (Min 1–5)<br/>§ 5 LDO Aufsicht<br/>§ 23/2 BaySchO Wegnahme/Sicherstellung<br/>BayPolG (ggf. 110)"]:::ga
    SR["**Schulrecht** (Min 5 → Tag 14)<br/>Art. 86 BayEUG Erziehungs-/Ordnungsmaßnahme<br/>Art. 87 BayEUG Sicherungs-Ausschluss<br/>Art. 88 BayEUG Verfahren"]:::sr
    ST["**Strafrecht** (Bund — persönlich)<br/>§ 241 StGB Bedrohung<br/>§ 224 StGB gef. KV<br/>(< 14 J. → § 8a SGB VIII Jugendamt)"]:::st
    ...
    classDef ga fill:#fefce8,stroke:#ca8a04,color:#1f2937
    classDef sr fill:#eff6ff,stroke:#1e3a8a,color:#1f2937
    classDef st fill:#fef2f2,stroke:#9f1239,color:#1f2937
```
...
**§ 23 BaySchO** (verbatim · verified-1:1):
...
*verified-1:1 · gesetze.legal/bayern/bayscho/23 · BaySchO § 23*
...
**§ 5 LDO Aufsichts-Schlüsselsatz** (verified-1:1, kurz; Vollzitat → **MP_06 A.2**):
...
*verified-1:1 · gesetze-bayern.de/Content/Document/BayVwV288393-5 · LDO § 5 Abs. 1 — Auszug*
...
**Verbatim Abs. 1 + Abs. 3** (verified-1:1; Schlüsselsätze):
...
*verified-1:1 · gesetze.legal/bayern/bayeug/86 · Auszug Abs. 1 + Abs. 3, Wortlaut gekürzt*

**12-Punkte-Katalog Abs. 2** (partial-summary; Punkte 1-3 verbatim, Punkte 4-12 summarisch — Detail-Pull ausstehend):
...
*partial-summary · gesetze.legal/bayern/bayeug/86 · Abs. 2 Punkte 4–12 Detail-Wortlaute summarisch*
...
!!! warning "⚠ Fallen Art. 86 BayEUG"
    - **12 Stufen** im Katalog Abs. 2 — Punkte 4–12 partial-summary (Detail-Wortlaute prüfen!).
...
*sinngemäß · Art. 87 BayEUG · nicht im Source-Repo verbatim — Anker fehlt*
...
*sinngemäß · Art. 88 BayEUG · nicht im Source-Repo verbatim — Anker fehlt*
...
**Cross-Ref Verwaltungsverfahren**: Art. 28 BayVwVfG Anhörungsanker (*nicht im Source-Repo verbatim — Anker fehlt*) — schulrechtliche Spezialregelung in Art. 88 verdrängt für Ordnungsmaßnahmen.
...
*sinngemäß · § 241 StGB · nicht im Source-Repo verbatim — Anker fehlt*
...
*sinngemäß · § 224 StGB · nicht im Source-Repo verbatim — Anker fehlt*
...
*sinngemäß · § 138 StGB · nicht im Source-Repo verbatim — Anker fehlt*
...
*sinngemäß · § 8a SGB VIII · nicht im Source-Repo verbatim — Anker fehlt*
...
| **M04** | **Art. 86/2 BayEUG-Katalog**: 12 Stufen (1 Verweis · 2 verschärfter Verweis · 3 Parallelklasse · 4 4-Wochen-Ausschluss · 5 6-Tage-Ausschluss · 6 2-4-Wo. bei schul. Gefährdung · 7 Schuljahresende · 8 andere Schule · 9 Androhung Entlassung · 10 Entlassung · 11 Schulart-Ausschluss · 12 Mehr-Schularten-Ausschluss). Punkte 4-12 partial-summary. |
...
| **FA04** | „Ausschluss 2–4 Wochen entscheidet die Schulleitung" | **NEIN**. Art. 86/2 Nr. 6 bei schulischer Gefährdung = **Lehrerkonferenz** (Anker; Detail-Wortlaut partial-summary). |
...
*[§ 23 BaySchO]: BaySchO § 23 — Verbote (Alkohol/Rauschmittel) + Wegnahme/Sicherstellung gefährlicher Gegenstände (verified-1:1)
*[§ 23/2 BaySchO]: BaySchO § 23 Abs. 2 — Mitführen + Wegnahme + Rückgabe gefährlicher Gegenstände bei Minderj. nur an EB (verified-1:1)
*[Art. 56/4 BayEUG]: BayEUG Art. 56 Abs. 4 — SuS-Verhaltenspflicht (verified-1:1)
*[Art. 86 BayEUG]: BayEUG Art. 86 — Erziehungs- und Ordnungsmaßnahmen (Abs. 1+3 verbatim, Abs. 2 12-Punkte-Katalog partial-summary)
*[Art. 87 BayEUG]: BayEUG Art. 87 — Sicherungsmaßnahme / vorläufiger Ausschluss (Anker; out-of-repo)
*[Art. 88 BayEUG]: BayEUG Art. 88 — Verfahren bei Ordnungsmaßnahmen (Anker; out-of-repo)
...
*[§ 5 LDO]: LDO § 5 — Aufsichtspflicht (verified-1:1, VERWEIS MP_06 A.2)
*[§ 241 StGB]: StGB § 241 — Bedrohung (Bund-Anker; out-of-repo)
*[§ 224 StGB]: StGB § 224 — gefährliche Körperverletzung (Bund-Anker; out-of-repo)
*[§ 138 StGB]: StGB § 138 — Anzeigepflicht geplanter schwerer Straftaten (Bund-Anker; out-of-repo)
*[§ 8a SGB VIII]: SGB VIII § 8a — Schutzauftrag bei Kindeswohlgefährdung (Bund-Anker; out-of-repo)
*[§ 1 JGG]: JGG § 1 — Strafmündigkeit ab vollendetem 14. Lebensjahr (Bund-Anker; out-of-repo)
