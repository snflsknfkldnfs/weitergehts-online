...
```mermaid
flowchart TB
 BV["**BV** · Bayerische Verfassung<br/>Art. 131 (Bildungs-/Erziehungsauftrag)"]:::bv
 BAY["**BayEUG** · Bay. Erziehungs- und Unterrichts-Gesetz<br/>Art. 56/4 (SuS-Verhaltenspflicht — ) · Art. 86 (Erziehungs-/Ordnungs-Maßnahmen — ) · Art. 87 (Sicherungs-Ausschluss — Anker) · Art. 88 (Verfahren — Anker) · Art. 57 (SL-Gesamtverantwortung — Anker) · Art. 75 (Unterrichtungspflicht EB — Anker)"]:::bay
 VO["**BaySchO + LDO** · Verordnungen<br/>BaySchO § 23/1 (Konsumverbot) · § 23/2 (Wegnahme/Sicherstellung — ) · LDO § 5 (Aufsicht —, VERWEIS MP_06)"]:::vo
