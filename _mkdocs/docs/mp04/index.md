...
Schullaufbahn-Steuerung ist eine **Trias aus SuS-Leistung, Eltern-Wahl und Schul-Beratung**: Eltern entscheiden Schulart und -wechsel (Art. 44 BayEUG · Elternwahlrecht), gebunden an **Eignung und Leistung** (Art. 44 + BV Art. 132 — Anlagen/Leistungs-Prinzip). Die Schule **berät** strukturell (Art. 78 BayEUG verified-1:1), die Lehrerkonferenz **entscheidet** über Vorrücken/Wiederholung (Art. 53 BayEUG · *out-of-repo — Anker*; MS-Konkretion: § 12 MSO LNW + MSO §§ 19 ff. ESA-Bestehensformel out-of-repo). Vorrücken-Anker = Leistung in Vorrückungsfächern; Beratungs-Pflicht (Art. 78) reicht von Probeunterrichts-Beratung bis zu drei MS-Aufstiegswegen Richtung Hochschulreife. **Vier MS-Abschlüsse**: ESA, Quali, MSA (M10), Praxisklassen-Abschluss (§ 22 MSO partial-verbatim) + Quabi (§ 34 MSO partial-verbatim).

## Norm-Kartografie (5 Ebenen)

```mermaid
flowchart TB
    BV["**BV** · Bayerische Verfassung<br/>Art. 128 · 129 · 132 · 133<br/><i>BV Art. 132 = Anlagen/Leistungs-Prinzip · out-of-repo Anker</i>"]:::bv
    BAY["**BayEUG** · Bay. Erziehungs- und Unterrichts-Gesetz<br/>Art. 7 · 7a · 7b · 35 · 41 · 43 · 44 · 52 · 53 · 76 · 78 · 84 · 86<br/><i>verbatim-Anker im Source-Repo: Art. 35 · 41 · 52/1 · 52/3 · 76 · 78 · 84 (Werbung) · 86; Art. 7 · 7a · 7b · 43 · 44 · 53 nicht im Source-Repo verbatim — Anker.</i>"]:::bay
    VO["**VO** · Schulordnungen<br/>MSO §§ 6 · 7 · 8 · 10 · 12 · 14 · 22 · 34 · BaySchO § 28 · § 32 · § 41/1<br/><i>verbatim-Anker MSO § 12/1+12/2+12/3+12/4 + § 14; § 22 + § 34 partial-summary; MSO § 6 · 7 · 8 · 10 nicht im Source-Repo verbatim — Anker.</i>"]:::vo
    KM["**KMBek** · Kultusministerielle Bekanntmachung<br/>QA-MS · MSA · ext. Bewerbung<br/><i>nicht öffentlich strukturiert verfügbar — Skeleton-Anker</i>"]:::km
    BU["**Bundesrecht** · GG Art. 12 · BGB §§ 1626 ff.<br/><i>(MP_04-randständig — Eltern-Sorgerecht-Anker; nicht im Source-Repo verbatim — Anker)</i>"]:::bu
...
|---|---|
| **BV** | Art. 128 (Bildungsanspruch) · 129 (Schulpflicht/Unentgeltlichkeit) · **132 (Anlagen+Leistung+innere Berufung)** · 133 (Bildungsträger) — *(BV Art. 128/132/133 nicht im Source-Repo verbatim — Anker)* |
| **BayEUG** | Art. 7/7a/7b (MS/M-Zug/bes. Schulart, *out-of-repo*) · **35 (Schulpflicht, verified-1:1)** · **41 (FöS-Lernort, verified-1:1)** · 43 (Schulartwechsel, *out-of-repo*) · 44 (Elternwahlrecht, *out-of-repo*) · **52/1 + 52/3 (LNW + Zeugnis, verified-1:1)** · 53 (Vorrücken/Wiederholung — KERN-NORM, *out-of-repo*) · **76 (Eltern-Mitwirkung, verified-1:1)** · **78 (Schulberatung, verified-1:1)** · 84 (verified-1:1 — Werbung/Vertrieb; **NICHT Abschluss-Anker**) · **86 (Erziehungs-/Ordnungsmaßnahmen, partial-summary)** |
| **VO** | **MSO § 12/1+/2+/3+/4 (LNW Mittelschule, verified-1:1)** · **§ 14 (individueller Förderplan, verified-1:1)** · § 22 (Praxisklassen-Abschluss, *partial-summary*) · § 34 (Quabi, *partial-summary*) · § 6 / § 7 / § 8 / § 10 (Gelenkklasse / M-Zug / Durchlässigkeit / Schülerpflichten — *out-of-repo*) · **BaySchO § 28 (Hausaufgaben, verified-1:1)** · **§ 32 (Individuelle Unterstützung, verified-1:1)** · **§ 41/1 (Schülerakte-Einsicht, verified-1:1; Verweis MP_09)** · GrSO § 6 / § 10 (GS-Übertritt, *out-of-repo* — Stoff MP_03) |
| **KMBek** | QA-Mittelschule (Quali) · MSA Mittelschule · ext. Bewerbung — *(KMBek-Volltext nicht öffentlich strukturiert verfügbar — Skeleton-Anker)* |
| **Bundesrecht** | GG Art. 12 (Berufswahl-Anker, MP_04-randständig) · BGB §§ 1626 ff. (Sorgerecht — Eltern-Antragsrecht) — *(out-of-repo — Anker)* |

---


!!! abstract "Begleit-Material"
    - 🃏 [**Anki-Lerndeck** (8 Karten · 10 Falle · 5 Hochprior)](https://weitergehts.online/lerndecks/schulrecht-mp04-schulartenrecht-schullaufbahn/)
    - 📑 [**Themen-Übersichtsseite**](https://weitergehts.online/staatsexamen/schulrecht/4-schulartenrecht-schullaufbahn/)

# Teil A — Stoff

## A.1 Schullaufbahn-Akteure + Entscheidungs-Trias (SuS · EB · Schule)

**Verfassungsanker (BV Art. 132)** — Bildungsweg-Maßstab: **Anlagen + Neigungen + Leistung + innere Berufung**, NICHT wirtschaftliche/gesellschaftliche Stellung der Eltern. *(BV Art. 132 nicht im Source-Repo verbatim — Anker; siehe MP_03 A.1)*
...
| **Erziehungsberechtigte** | Anmeldung · Wahl der Schulart (Vorbehalt Eignung) · Mitwirkungspflicht · Lernort-Wahl bei FöS | **Art. 76 BayEUG** + Art. 41/1 + Art. 44 *(out-of-repo)* |
...
**Eltern-Mitwirkungspflicht (Art. 76 BayEUG · verified-1:1)**:
...
*verified-1:1 · gesetze.legal/bayern/bayeug/76 · Auszug Abs. 1+2*

**Beratungs-Pflicht (Art. 78 BayEUG · verified-1:1)** — Schule + Schulaufsicht **beraten** Eltern + SuS in Schullaufbahn-Fragen, geben Hilfen entsprechend Anlagen + Fähigkeiten. Beratung ist STRUKTURELL — keine Schulwahl-Entscheidung der LK.

**Elternwahlrecht (Art. 44 BayEUG · *out-of-repo — Anker*)**: Eltern wählen Schulart/Ausbildungsrichtung/Fachrichtung — **gebunden an Eignung + Leistung**. Spezial-Aufnahmeprüfungen (z.B. Gym-Probeunterricht GS 4) sind zulässig.

**Lernort-Entscheidung bei sonderpäd. Förderbedarf (Art. 41 BayEUG · verified-1:1)** — Auszug:
...
*verified-1:1 · gesetze.legal/bayern/bayeug/41 · Auszug Abs. 1+6, Wortlaut gekürzt*
...
!!! warning "⚠ Fallen Trias"
    ...
    - **Förderschul-Aufnahme** setzt sonderpäd. Gutachten voraus (Art. 41/4 BayEUG verified-1:1).
...
**Rechtsanker**: **Art. 53 BayEUG (Vorrücken/Wiederholen — KERN-NORM)** *(nicht im Source-Repo verbatim — Anker fehlt)*. Detail-Regelungen in den Schulordnungen. Für die Mittelschule: **§ 12 MSO** als LNW-Grundlagen-Anker.

### LNW-Grundsatz (Art. 52/1 BayEUG · verified-1:1)
...
*verified-1:1 · gesetze.legal/bayern/bayeug/52*

**Direktionalität**: SuS → LNW erbringen · LK → vorher bekannt geben + mit Notenstufe + Begründung eröffnen.

### Notenstufen Art. 52/2 BayEUG (Auszug verbatim · partial-summary)
...
*partial-summary — Auszug verbatim · gesetze.legal/bayern/bayeug/52 · Abs. 2*

### Zeugnis-Bewertung (Art. 52/3 BayEUG · verified-1:1)
...
### LNW-Festlegungen Lehrerkonferenz (§ 12/1 MSO · verified-1:1)
...
*verified-1:1 · gesetze.legal/bayern/mso/12*

### Vorrückungs-Logik MS (KMBek/MSO §§ 19 ff. · *out-of-repo — Anker*)

**Vorrückungsfächer MS**: Kernfächer D/M/E + Pflichtfach nach Jgst. *(Detailliste in MSO §§ 19 ff. — out-of-repo)*

**Bestehensformel ESA** (Erfolgreicher Mittelschulabschluss — *MSO §§ 19 ff. out-of-repo*): Durchschnitt Vorrückungsfächer ≥ **4,00** + max. **3 Fächer schlechter als 4** (Note 6 zählt wie 2× Note 5).

**Vorrücken auf Probe**: knappes Notenbild → Lehrerkonferenz/SL-Entscheidung *(out-of-repo — Anker)*.

**Freiwilliges/Pflichtwiederholen**: Antrag der Eltern bzw. Lehrerkonferenz-Beschluss; Wiederholungsfristen sind in MSO §§ 19 ff. geregelt *(out-of-repo)*.

**Überspringen**: Antrag mit Leistungsnachweis · SL-Genehmigung *(out-of-repo)*. **Verkürzung** der Vollzeitschulpflicht durch Überspringen möglich; **keine Verlängerung** durch Streckung (Art. 35/2 BayEUG: „zwölf Jahre, soweit dieses Gesetz nichts anderes bestimmt").

!!! warning "⚠ Fallen Vorrücken/Wiederholung"
    - **Art. 53 BayEUG ist KERN-NORM** — aber im Source-Repo *out-of-repo* (Anker). Detail-Werte müssen aus MSO §§ 19 ff. (ebenfalls out-of-repo) entnommen werden — **Sekundärliteratur cross-checken!**
...
**Verfassungs- + Gesetzes-Anker**: BV Art. 132 (Anlagen/Leistung) + Art. 44 BayEUG (Elternwahl) + Art. 43 BayEUG (Schulartwechsel). *(Alle drei nicht im Source-Repo verbatim — Anker)*

**Schularten-Definitionen**:
- **Art. 7 BayEUG** — Mittelschule (Aufgaben) — *out-of-repo*
- **Art. 7a BayEUG** — Mittlere-Reife-Klassen (M-Zug) — *out-of-repo* (KERN-NORM für M-Zug-Übertritt!)
- **Art. 7b BayEUG** — Schulen besonderer Art (Modellprojekte; NICHT mit „Profil Inklusion" Art. 30a/4 verwechseln) — *out-of-repo*

### Übertritts-Schwellen (Übersicht; Wortlaut-Quelle out-of-repo)

=== "GS 4 → Sek I (Spiegel-Stoff MP_03 A.4)"

    **Mai-ÜZ Jgst. 4, nur D/M/HSU zählen.** *(GrSO § 6 + § 10 — out-of-repo; Detailbehandlung in MP_03 A.4)*
...
=== "MS 5 → Gym/RS (Gelenkklasse · § 6 MSO)"
    ...
    **Jahreszeugnis Jgst. 5 MS.** *(MSO § 6 nicht im Source-Repo verbatim — Anker)*
...
=== "MS → M-Zug (Mittlere-Reife-Klasse · § 7 MSO)"
    ...
    *(MSO § 7 nicht im Source-Repo verbatim — Anker)*
    ...
    **Rückkehr MS↔M-Zug jederzeit** (§ 8 MSO out-of-repo).

=== "MS 5–9 → Gym/RS außerhalb Gelenkklasse"

    *(out-of-repo — Anker)*: Aufnahmeprüfung in den letzten Tagen der Sommerferien + Probezeit. RS-Alternative: D+M+E ≤ 2,0 im Jahreszeugnis.

=== "MS → Wirtschaftsschule (4-stufige WS, Jgst. 7)"

    *(out-of-repo — Anker)*: aus 6./7. Klasse MS Jahreszeugnis D+M+E ≤ 2,66 uneingeschränkt; alternativ M-Zug-Vorrückungserlaubnis aus 7. ; sonst Probeunterricht (3 Tage).
...
flowchart LR
    MS["MS 5"]:::start
    A1["M7<br/>D+M+E ≤ 2,66"]:::pa
    A2["M10 + MSA"]:::pa
    A3["FOS 11/12"]:::eA
    AF["Fach-/Hochschulreife"]:::goal

    B1["ESA Ende 9."]:::pb
    B2["Quali<br/>50/50 + Projekt"]:::pb
    B3["Berufsausbildung + BS"]:::pb
    B4["Quabi MSO § 34"]:::pb
    B5["FOS 11/12"]:::eB

    C1["WS 4-stufig<br/>Jgst. 7"]:::pc
    C2["Mittlerer Abschluss"]:::pc
    C3["FOS 11/12"]:::eC
    ...
    classDef pa fill:#fefce8,stroke:#ca8a04,color:#1f2937
    classDef pb fill:#f7fee7,stroke:#65a30d,color:#1f2937
    classDef pc fill:#eff6ff,stroke:#1e3a8a,color:#1f2937
    classDef eA fill:#fefce8,stroke:#ca8a04,color:#1f2937
    classDef eB fill:#f7fee7,stroke:#65a30d,color:#1f2937
    classDef eC fill:#eff6ff,stroke:#1e3a8a,color:#1f2937
...
!!! warning "⚠ Fallen Übertritt"
    ...
    - **Art. 7a BayEUG (M-Zug) ≠ Art. 7b BayEUG (Schule besonderer Art)** ≠ Art. 30a/4 (Profil Inklusion verified-1:1) — drei verschiedene Anker.
...
**Rechtsanker MS-LNW**: **§ 12 MSO Container** (verified-equivalent → Volltexte unter § 12/1, /2, /3, /4 verified-1:1). *Container — Volltext via § 12/1, § 12/2, § 12/3, § 12/4.*

### Ankündigung schriftlicher LNW (§ 12/2 MSO · verified-1:1)
...
### LNW-Rückgabe (§ 12/3 MSO · verified-1:1 — KRITISCHE Direktionalitäts-Falle!)
...
### Projektprüfung Jgst. 9 Regelklasse (§ 12/4 MSO · verified-1:1)
...
### Hausaufgaben (§ 28 BaySchO · verified-1:1)
...
*verified-1:1 · gesetze.legal/bayern/bayscho/28 · Abs. 1+2*
...
**Rechtsrahmen**: **Art. 7 BayEUG** (MS-Aufgaben — *out-of-repo*) verweist auf MSO §§ 19 ff. (Quali) · §§ 30 ff. (MSA M10) · § 22 (Praxisklassen-Abschluss) · § 34 (Quabi). Im Source-Repo verbatim verfügbar: **§ 22 MSO + § 34 MSO (partial-summary mit Auszügen)**. Quali + MSA = **KMBek-Anker (out-of-repo)**.

### Vier MS-Abschlüsse + Quabi (Übersicht)

| Abschluss | Norm | Bestehensformel / Voraussetzung |
|---|---|---|
| **ESA** (Erfolgreicher MS-Abschluss) — Ende 9. | MSO §§ 19 ff. *(out-of-repo)* | Vorrückungsfächer-Schnitt ≥ **4,00** + max. **3 Fächer schlechter als 4** (Note 6 = 2× Note 5) |
| **Quali** (qualifizierender MS-Abschluss) — freiwillig Ende 9. | MSO §§ 26 ff. + KMBek QA-MS *(out-of-repo)* | **50 % Jahresfortgang + 50 % Prüfung**; Fächer D/M/E + PCB/GSE/AWT + **Projektprüfung** |
| **MSA** (Mittlerer Schulabschluss M10) | MSO §§ 30 ff. + KMBek MSA *(out-of-repo)* | schriftl./mündl./prakt. Prüfungen am Ende M10 |
| **Praxisklassen-Abschluss** | **§ 22 MSO** *(partial-summary)* | theorieentlastete Prüfung; Bestehen ≤ **4,0**; Projektnote **doppelt** |
| **Quabi** (qualifizierter beruflicher Bildungsabschluss) | **§ 34 MSO** *(partial-summary)* | Quali + Berufsabschluss (Notendurchschnitt mind. **3,0**) + Englisch „ausreichend" |

### § 22 MSO — Praxisklassen-Abschluss (partial-summary)
...
*partial-summary — Auszüge verbatim · gesetze.legal/bayern/mso/22*
...
*partial-summary — Auszüge verbatim · gesetze.legal/bayern/mso/34*

**Werte (verbatim)**: Berufsabschluss Notendurchschnitt mindestens **3,0** · Englisch-Note „**ausreichend**" (= Note 4).

### Externe Bewerbung Quali / MSA (KMBek · *out-of-repo*)

SuS, die nicht als Regelschüler an einer MS sind (z.B. wechselnde Schulart, Privatschule, Sonderfälle), können Quali bzw. MSA über **externe Bewerbung** erlangen — Termine + Modalitäten via KMBek-Anker (*nicht öffentlich strukturiert verfügbar — Skeleton-Anker*).

### Förderung bei Lernschwierigkeiten

**§ 14 MSO — Individueller Förderplan (verified-1:1)**:
...
*verified-1:1 · gesetze.legal/bayern/mso/14*

**§ 32 BaySchO — Individuelle Unterstützung (verified-1:1)** — 7-Maßnahmen-Katalog Abs. 2: 1. besondere Arbeitsmittel · 2. Räumlichkeiten · 3. Pausenregelungen · 4. Hand-/Lautzeichen + Symbole · 5. individuelle Arbeitsanweisungen · 6. **HA-Differenzierung** · 7. Visualisierung+Verbalisierung. KRITISCH: gilt nur „**soweit nicht die Leistungsfeststellung berührt wird**" — Abgrenzung zu Nachteilsausgleich (§ 33 BaySchO).

**Schullaufbahn-Sanktionen (Art. 86 BayEUG · partial-summary)**: Erziehungsmaßnahmen ZUERST, dann Ordnungsmaßnahmen. Schullaufbahn-relevante OM in Abs. 2 (Punkt 8 = Zuweisung an andere Schule; Punkt 9 = Androhung Entlassung; Punkt 10 = Entlassung; Punkt 11+12 = Schulart-Ausschluss).
...
*verified-1:1 · gesetze.legal/bayern/bayeug/86 · Abs. 1, Wortlaut gekürzt*
...
!!! warning "⚠ Fallen Abschlüsse"
    ...
    - **Art. 84 BayEUG ist verbatim Werbung/Vertrieb** — Schullaufbahn-Abschluss-Anker = Art. 84/85 BayEUG sind eine **andere out-of-repo-Ref** (Detail in MSO).
...
| FA03 | Probearbeiten Jgst. 4 = „10/4/4 D/M/HSU" verbatim? | **NEIN** — GrSO § 10 (out-of-repo) sagt verbatim nur **„insgesamt 18"** + **„mind. 4 Wochen probearbeiten-frei"** in den drei genannten Fächern; Verteilung 10/4/4 ist Sekundärliteratur. |
...
| FA08 | Art. 84 BayEUG = Abschluss-Regelung? | **NEIN** — Art. 84 BayEUG (verified-1:1) ist **Werbung/Vertrieb** (politische Werbung verboten). Abschluss-Anker (Art. 84/85 BayEUG) sind out-of-repo-Refs; konkrete Abschluss-Werte stehen in MSO §§ 19 ff. (out-of-repo) bzw. § 22, § 34 MSO (partial-summary verbatim). |
| FA09 | M-Zug-Schwellen alle = 2,33? | **NEIN** — M7 ≤ **2,66** · M8/M9/M10 ≤ **2,33** (§ 7 MSO out-of-repo). |
...
??? example "Fall **Leonie** — Quabi-Voraussetzung (§ 34 MSO)"
    ...
    **Knackpunkte**:
    ...
    3. **Quali als Vorbedingung** ✓ (KMBek QA-MS, out-of-repo).
...
??? example "Fall **Arda** — Förderplan-Pflicht (§ 14 MSO)"
    ...
    **Knackpunkte**:
    ...
    2. **Diagnostik-Vorstufe**: sonderpäd. Gutachten (Art. 41/4 BayEUG verified-1:1) für Förderbedarfs-Feststellung.
    ...
    6. **§ 32 BaySchO Individuelle Unterstützung** (verified-1:1) parallel zulässig — ABER nur „**soweit nicht die Leistungsfeststellung berührt wird**" (Abgrenzung Nachteilsausgleich).
...
??? example "Fall **Familie Çelik** — M-Zug-Wechsel (§ 7 MSO + Art. 78 BayEUG)"
    ...
    **Knackpunkte**:
    ...
    2. **Art. 78 BayEUG Beratungs-Pflicht** (verified-1:1): Schule muss Eltern + SuS in Schullaufbahn-Fragen beraten — entsprechend „**Anlagen und Fähigkeiten**".
    3. **§ 8 MSO Durchlässigkeit** (out-of-repo): Rückkehr M-Zug → Regelklasse jederzeit möglich, falls M-Zug-Anforderungen nicht passen.
    4. **Art. 44 BayEUG Elternwahlrecht** (out-of-repo): Eltern entscheiden, gebunden an Eignung/Leistung (Schwelle erfüllt → Wahl frei).
...
- **Trias SuS/EB/Schule (A.1) ↔ MP_05 A.1** — SuS-Pflichten (Art. 56/4 BayEUG verified-1:1) entfalten die Schullaufbahn-Pflichtenseite, die hier in MP_04 als Eltern-Wahl-Komplement dargestellt ist.
- **LNW-Rückgabe (§ 12/3 MSO, A.4) + Notenauskunft ↔ MP_05 A.3** — Auskunfts-Anspruch SuS (Art. 56/2 Nr. 4 BayEUG verified-1:1, Hannah-Falle) korrespondiert mit dem in A.4 verbatim verankerten LNW-Erhebungs-Pflichten der LK (Art. 52/1 BayEUG).
- **§ 41 BaySchO Schülerakte (A.5 Praxisklassen-Schulbesuchsjahr-Diagnose) ↔ MP_09 A.2** — § 41/1 BaySchO (verified-1:1) Einsichtsrecht ab Vollendung 14. Lj. ist die Datenschutz-Schiene für Schullaufbahn-Daten.
...
- **BV**: Art. 128 (Bildungsanspruch) · 129 (Schulpflicht/Unentgeltlichkeit) · **132 (Anlagen + Leistung + innere Berufung)** · 133 (Bildungsträger). *(BV-Refs nicht im Source-Repo verbatim — Anker)*
- **BayEUG**: Art. 7/7a/7b/35/41/43/44/52/53/76/78/84/86. *(verified-1:1 im Source-Repo: Art. 35 · 41 · 52/1 · 52/3 · 76 · 78 · 84 (Werbung) · 86; out-of-repo: Art. 7 · 7a · 7b · 43 · 44 · 53)*
- **Schulordnungen**: **MSO § 12/1+/2+/3+/4 · § 14** *(verified-1:1)* · § 22 · § 34 *(partial-summary)* · § 6 · § 7 · § 8 · § 10 *(out-of-repo)* · **BaySchO § 28 · § 32 · § 41/1** *(verified-1:1)* · GrSO § 6 · § 10 *(out-of-repo)*.
- **KMBek**: QA-Mittelschule (Quali) · MSA Mittelschule · ext. Bewerbung. *(KMBek-Volltext nicht öffentlich strukturiert verfügbar — Skeleton-Anker)*
- **Bundesrecht**: GG Art. 12 · BGB §§ 1626 ff. *(out-of-repo — Anker)*
