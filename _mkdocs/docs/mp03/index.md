...
flowchart TB
    ...
    BAY["**BayEUG** · Bay. Erziehungs- und Unterrichts-Gesetz<br/>Art. 3 · 6 · 7/7a/8/9 · 11–18 · 19–24 · 35 · 37 · 39 · 41 · 43 · 44 · 76 · 78 · 90–105 · 118–120<br/><i>verbatim-Anker: Art. 6 · 19 · 20 · 35 · 36/3 · 41 · 56/4 · 76 · 78 · 84 · 86 · 118; übrige nicht im Source-Repo verbatim — Anker.</i>"]:::bay
...
| **BayEUG** | Art. 3 (öff./privat) · 6 (Schularten) · 7/7a/8/9 (GS/MS/RS/Gym) · 11–18 (berufliche) · 19–24 (FöS) · 35 (Schulpflicht) · 37 (Stichtag/Korridor) · 39 (BS-Pflicht) · 41 (FöS-Lernort) · 43 (Schulartwechsel) · 44 (Elternwahlrecht) · 76 (Eltern-Mitwirkung) · 78 (Beratung) · 90–105 (Privatschulen) · 118–120 (Schulzwang) — *verbatim-Anker im Source-Repo: Art. 6 · 19 · 20 · 35 · 36/3 · 41 · 56/4 · 76 · 78 · 84 · 86 · 118; Art. 7/7a/8/9 · 37 · 39 · 43 · 44 · 90–105 · 119/120 sind nicht im Source-Repo verbatim — Anker* |
...
**Privatschulen** (Art. 90–105 BayEUG · *Art. 90–105 nicht im Source-Repo verbatim — Anker*; Verfassungsanker BV Art. 134 verified-1:1):
...
- **Allgemein bildend**: GS (Art. 7, Jgst. 1–4) · MS (Art. 7a, 5–9/M-Zug 5–10) · RS (Art. 8, 5–10) · Gym (Art. 9, 5–13 G9) · Abendrealschule/-gymnasium · Kolleg. *(Art. 7/7a/8/9 nicht im Source-Repo verbatim — Anker)*
- **Beruflich** (Art. 11–18): BS · BFS · WS · FS · FOS · BOS · FA. *(nicht im Source-Repo verbatim — Anker)*
- **Förderschulen** (Art. 19–24): 7 Förderschwerpunkte (Art. 20/1 verified-1:1); Grund-/Mittel-/Berufsschulstufe.
- **Schulen für Kranke** (Art. 41/2 verified-1:1).
...
**Vorkurs Deutsch 240** (KMBek KWMBl 2011 S. 240) *(Werte aus KMBek-Skeleton — KMBek-Volltext nicht öffentlich strukturiert verfügbar)*: **240 Stunden über 1,5 Schuljahre** — vorletztes + letztes KiTa-Jahr — für Kinder mit Sprachförderbedarf. Je Hälfte KiGa und GS.
...
**Stichtag + Korridor (Art. 37 BayEUG)** *(Art. 37 nicht im Source-Repo verbatim — Anker)*:
...
**Berufsschulpflicht (Art. 39 BayEUG)** *(nicht im Source-Repo verbatim — Anker; Werte aus Sekundärliteratur K — vor Prüfungseinsatz cross-check)*: nach Vollzeitschulpflicht; **3 BS-Jahre** (Spanne 2–3½), spätestens Ende des Schuljahres, in dem SuS **21. Lebensjahr** vollendet. Ausnahmen: mittlerer Abschluss + kein Ausbildungsverhältnis · Hochschulzugang · BVJ/BGJ · Beamten-Vorbereitungsdienst · FSJ/FÖJ · Bundeswehr.

**Schulpflicht-Überwachung & Sanktion**:

- **Art. 76 BayEUG (verified-1:1) + § 20 BaySchO (verified-equivalent)**: Eltern + Schule überwachen gemeinsam.
- **Art. 119 BayEUG**: **Ordnungswidrigkeit** + Geldbuße bei Unterlassung Anmeldung. *(nicht im Source-Repo verbatim — Anker)*
- **Art. 118 BayEUG — Schulzwang** (verified-1:1): Wortlaut sagt „**auf Antrag der Schule** von der Kreisverwaltungsbehörde durch ihre **Beauftragten** zwangsweise der Schule zugeführt" — Akteur ist „die Schule" (der Antragsweg läuft über die SL, aber Wortlaut differenziert nicht zwischen SL und Schule).
- **Art. 120 BayEUG**: Grundrechtseinschränkung Freiheit/Wohnung zugunsten Schulpflicht. *(nicht im Source-Repo verbatim — Anker)*
...
!!! warning "⚠ Fallen Schulpflicht"
    ...
    - **JuSchG § 1** (verified-1:1, „Lieblingsbegriff Schulräte"). Wortlaut Kind: `Kinder Personen, die noch nicht 14 Jahre alt sind`. Wortlaut Jugendliche: `Jugendliche Personen, die 14, aber noch nicht 18 Jahre alt sind`. „Sittliche Reife" als zusätzliches Tatbestands-Merkmal — oft übersehen.

## A.4 Übertritt (Art. 43/44 BayEUG · GrSO § 6/§ 10 · MSO § 6/7/8)

**Rechtsgrundlage**: Art. 43 BayEUG (Schulartwechsel) · Art. 44 (Elternwahlrecht) *(Art. 43 + 44 nicht im Source-Repo verbatim — Anker)* · GrSO/MSO/RSO/GSO/WSO Schulart-spezifisch.
...
=== "GS 4 → Sek I"
    ...
    **Probearbeiten** (GrSO § 10 — verified-1:1): „**In Klasse 4 sollen insgesamt 18 Probearbeiten abgehalten werden in den drei genannten Fächern**" (D/M/HSU). Verteilung 10/4/4 ist Sekundärliteratur-Auslegung *(Killinger-Komm. — vor Prüfungseinsatz cross-check)*; Wortlaut nennt nur die Gesamtzahl 18. Verteilung durch **Lehrerkonferenz** (§ 10 Abs. 1 GrSO: „Die Lehrerkonferenz legt vor Schuljahresbeginn grundsätzliche Regeln zur Erhebung von Leistungsnachweisen … fest"). „**In Jahrgangsstufe 4 sollen mindestens vier Unterrichtswochen von bewerteten Probearbeiten freigehalten werden in Deutsch, Mathematik und Heimat- und Sachunterricht**" — **kollektiv** (D/M/HSU, NICHT „pro Fach"); Wortlaut nennt KEINEN expliziten Bezug auf das ÜZ.
...
| FA03 | Probearbeiten-Verteilung Jgst. 4? | **Lehrerkonferenz** legt Grundsätze fest (GrSO § 10/1); insgesamt **18 Probearbeiten** in D/M/HSU (Wortlaut: „insgesamt 18", Verteilung 10/4/4 nur Sekundärliteratur); **mindestens 4 Unterrichtswochen probearbeitenfrei** in D/M/HSU **kollektiv** (Wortlaut: „in Deutsch, Mathematik und Heimat- und Sachunterricht" — NICHT „pro Fach"). |
...
??? example "Fall **Theo** — JuSchG-Frage in mündlicher Prüfung (Querverweis)"
    ...
    **Knackpunkte**:
    ...
    1. **JuSchG § 1** (Wortlaut, verified-1:1). Kind: `Kinder Personen, die noch nicht 14 Jahre alt sind`. Jugendliche: `Jugendliche Personen, die 14, aber noch nicht 18 Jahre alt sind`. Personensorgeberechtigte/Erziehungsbeauftragte sind in Nr. 3 + 4 separat definiert.
