...
**Privatschulen** (Art. 90–105 BayEUG):
...
**Vorkurs Deutsch 240** (KMBek): **240 Stunden über 1,5 Schuljahre** — vorletztes + letztes KiTa-Jahr — für Kinder mit Sprachförderbedarf. Je Hälfte KiGa und GS.
...
- **Art. 118 BayEUG — Schulzwang**: Antrag SL → **Kreisverwaltungsbehörde** → zwangsweise Zuführung.
...
| **Praxisklasse-Abschluss** | **MSO § 22** | theorieentlastete Prüfung: D/DaZ 90 Min + M 60 Min + Fächerverbund 45 Min + Projekt AWT |
...
| FA03 | Probearbeiten-Verteilung Jgst. 4? | **LK-Konferenz** (nicht einzelne LK); 18 Probearbeiten bis ÜZ; 4 Wo. probearbeitenfrei vor ÜZ. |
...
| FA12 | JuSchG § 1 / sittliche Reife? | Definitionsquelle Kind (0–13) / Jugendlicher (14–17); „sittliche Reife" = altersangemessene Einschätzungsfähigkeit. „Lieblingsbegriff" Schulräte. |
...
??? example "Fall **Theo** — JuSchG-Frage in mündlicher Prüfung (Querverweis)"
    ...
    **Knackpunkte**:
    ...
    1. **JuSchG § 1**: Kind = unter 14 Jahren · Jugendlicher = 14 bis unter 18 · Personensorgeberechtigte/Erziehungsbeauftragte separat.
