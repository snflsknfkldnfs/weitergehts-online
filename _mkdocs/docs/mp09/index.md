...
flowchart TB
 ...
 P3["**Pfad 3: DSGVO-Auskunft**<br/>Art. 15 DSGVO + Art. 6/1/e<br/> <br/>kumulativ neben Pfad 2"]:::p3
...
4. **Ausnahmen** (Garantenstellung Kindeswohl): § 4 KKG (Datenübermittlung an Jugendamt) erlaubt Übermittlung an JA bei gewichtigen Anhaltspunkten — aber NICHT pauschalen Lehrerzimmer-Plausch.
...
5. **Pflichten zusätzlich aus DSGVO Art. 6/1/a + Art. 7 (Einwilligungs-Anforderungen)**: schriftlich, freiwillig, jederzeit widerrufbar.
...
2. **Differenzierung**: Polizei als Strafverfolgungsbehörde + konkreter Tatverdacht → Anfrage zulässig nach § 161 StPO + § 163 StPO; Schule darf hier idR auskunftspflichtig sein.
...
6. **DSGVO**: Art. 6/1/c (rechtliche Verpflichtung) + Art. 6/1/e (öffentliche Aufgabe) als Rechtsgrundlage —.
