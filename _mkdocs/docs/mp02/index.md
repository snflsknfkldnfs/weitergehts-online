...
Hausaufgaben sind nach **§ 28 BaySchO** (verified-1:1) ein notwendiger und verbindlicher Teil der Unterrichts- und Erziehungsarbeit — Stellpflicht der LK + **Drei-Sätze-Logik Abs. 1**: (1) gestellt werden, sodass sie bei „durchschnittlichem Leistungsvermögen in angemessener Zeit" bearbeitbar sind; (2) **Lehrerkonferenz legt vor Schuljahresbeginn die Grundsätze fest**; (3) **Sonntage, Feiertage UND Ferien sind freizuhalten** (drei Kategorien!). **MS-Spezifik**: KEINE feste Stundenzahl — das „bis zu einer Stunde"-Limit gilt **nur Grundschule + GS-Stufe Förderschulen** (§ 28/2 S. 1). HA-**Differenzierung** steht in **§ 32/2 Nr. 6 BaySchO** (verified-1:1) — NICHT in § 28 selbst. Beschwerde-Eskalation von SuS/EB: **Art. 56/2 Nr. 5 BayEUG** (verified-1:1) — „**nacheinander**" Lehrkraft → SL → Schulforum (NICHT parallel). Eltern haben **Mitwirkungspflicht Art. 76 BayEUG** (verified-1:1) — „achten auf" UND „unterstützen". **HA ≠ Leistungsnachweis** — Benotungsverbot folgt aus LNW-Definition (Art. 52 BayEUG) + Lehrplan-Vorgaben, NICHT direkt aus § 28 (Drift-Falle!). Bei systematisch nicht erledigten HA: Erziehungsmaßnahme „**Nacharbeit unter Aufsicht einer Lehrkraft**" nach **Art. 86/1 BayEUG** (verified-1:1) — eskaliert über EB-Mitteilung (Art. 75-Anker) zur Ordnungsmaßnahme nach Verhältnismäßigkeit.
...
```mermaid
flowchart TB
    BV["**BV** · Bayerische Verfassung<br/>Art. 131 (Bildungs-/Erziehungsauftrag, *nicht im Source-Repo verbatim — Anker*)"]:::bv
    BAY["**BayEUG** · Bay. Erziehungs- und Unterrichts-Gesetz<br/>Art. 56 (SuS-Rechte Container — partial-summary) · Art. 56/2 (5-Punkte-Beschwerde — verified-1:1) · Art. 76 (Eltern-Mitwirkung — verified-1:1) · Art. 86/1 (Nacharbeit — verified-1:1) · Art. 75 (EB-Unterrichtung — Anker) · Art. 65 (Elternbeirat-Anhörung — Anker)"]:::bay
    VO["**BaySchO + LDO** · Verordnungen<br/>BaySchO § 28 (HA — verified-1:1) · § 32 (Individuelle Unterstützung — verified-1:1) · § 22 (LK-Konferenz — Anker) · LDO § 5 (Aufsicht — verified-1:1, VERWEIS MP_06) · § 6/2 LDO (KL-Koordination — Anker)"]:::vo
    VWV["**Verwaltungsrecht** · BayVwVfG Art. 28 (Anhörung — Anker) · KMBek HA Grundschule (1-Stunde-Konkretisierung — Anker)"]:::vo
    BUND["**Bundesrecht** · Art. 6 GG (Eltern-Erziehungsrecht — Anker) · Art. 7 GG (Schul-Aufsicht Bund — Anker)"]:::bund
...
|---|---|
| **BV** | Art. 131 BV (Bildungs-/Erziehungsauftrag, *nicht im Source-Repo verbatim — Anker fehlt*) |
| **BayEUG** | Art. 56 (Container — partial-summary) · **Art. 56/2** (5-Punkte SuS-Rechte / Beschwerde-Eskalation — verified-1:1) · **Art. 76** (Eltern-Mitwirkung — verified-1:1) · **Art. 86/1** (Erziehungsmaßnahmen incl. Nacharbeit — verified-1:1) · Art. 52 (LNW-Definition für HA-Abgrenzung — Anker, partial in Repo) · Art. 75 (EB-Unterrichtung — Anker) · Art. 64/65 (Elternbeirat — Anker) · Art. 57 (SL-Gesamtverantwortung — Anker) |
| **VO** | **BaySchO § 28** (HA Abs. 1+2 — verified-1:1; Abs. 3-6 partial) · **§ 32/2 Nr. 6** (HA-Differenzierung — verified-1:1) · § 22 BaySchO (LK-Konferenz — Anker) · **LDO § 5** (Aufsicht für Nacharbeit — verified-1:1, VERWEIS MP_06) |
...
!!! abstract "Begleit-Material"
    - 🃏 [**Anki-Lerndeck** (24 Karten · 10 Falle · 4 Hochprior)](https://weitergehts.online/lerndecks/schulrecht-mp02-hausaufgaben-beschwerde/)
    - 📑 [**Themen-Übersichtsseite**](https://weitergehts.online/staatsexamen/schulrecht/2-hausaufgaben-beschwerde/)

# Teil A — Stoff

## A.1 Was sind Hausaufgaben — § 28 BaySchO

**§ 28 BaySchO Abs. 1 + Abs. 2** (verbatim · verified-1:1):
...
*verified-1:1 · gesetze.legal/bayern/bayscho/28 · BaySchO § 28 Abs. 1 + Abs. 2 S. 1–2 · Auszug, Wortlaut gekürzt*
...
*verified-equivalent · gesetze.legal/bayern/bayscho/28 · BaySchO § 28 Abs. 2 Satz 3 — sinnerhaltende Wiedergabe (amtlicher Wortlaut über Quelle prüfbar).*

> *Detail-Hinweis*: Abs. 3–6 (HA-Detail-Bestimmungen für weiterführende Schularten) — *partial-summary; Detail-Wortlaut-Pull ausstehend*.
...
|---|---|---|---|
| **Grundschule + GS-Stufe Förderschulen** | „bis zu **einer Stunde**" als angemessen | § 28/2 S. 1 BaySchO (verified-1:1) | „bis zu" = Obergrenze, NICHT Mindestwert |
...
**§ 32 BaySchO** (verbatim · verified-1:1):
...
*verified-1:1 · gesetze.legal/bayern/bayscho/32 · BaySchO § 32 Abs. 1 + Abs. 2*
...
**Art. 56/2 BayEUG** (verbatim · verified-1:1):
...
*verified-1:1 · gesetze.legal/bayern/bayeug/56 · Art. 56 Abs. 2*

**Drei-Stufen-Beschwerde-Kette** (Nr. 5):

```mermaid
flowchart LR
    SUS["**SuS / EB**<br/>(Beschwerde wegen ungerechter Behandlung/Beurteilung)"]:::sus
    LK["**Stufe 1**<br/>Lehrkraft<br/>(KL bei Querthemen)"]:::lk
    SL["**Stufe 2**<br/>Schulleiterin/Schulleiter"]:::sl
    SF["**Stufe 3**<br/>Schulforum"]:::sf

    SUS --> LK
    LK -->|"nacheinander<br/>(NICHT parallel)"| SL
    SL --> SF

    classDef sus fill:#fff7ed,stroke:#c2410c,color:#1f2937
    classDef lk fill:#eff6ff,stroke:#1e3a8a,color:#1f2937
    classDef sl fill:#fefce8,stroke:#ca8a04,color:#1f2937
    classDef sf fill:#fef2f2,stroke:#9f1239,color:#1f2937
```
...
**Art. 86/1 BayEUG** (verbatim · verified-1:1; Nacharbeit-Schlüsselsatz):
...
*verified-1:1 · gesetze.legal/bayern/bayeug/86 · Art. 86 Abs. 1 — Auszug*

**§ 5 LDO** (verbatim · verified-1:1; Schlüsselsatz für Nacharbeit-Beaufsichtigung):
...
*verified-1:1 · gesetze-bayern.de/Content/Document/BayVwV288393-5 · LDO § 5 Abs. 1 — Auszug · Vollzitat siehe MP_06 A.2*
...
| 2 | **Erziehungsmaßnahme: Nacharbeit unter Aufsicht** | Art. 86/1 BayEUG (verified-1:1) + § 5 LDO Aufsicht |
| 3 | EB-Mitteilung (schriftlich) | Art. 75 BayEUG-Anker |
| 4 | LK-Konferenz-Grundsätze prüfen | § 28/1 S. 2 BaySchO (verified-1:1) |
...
!!! warning "⚠ Drift-Falle HA ≠ LNW"
    ...
    - Notenauskunft ggü. EB ist Recht aus Art. 56/2 Nr. 4 BayEUG (verified-1:1) + § 14/4 LDO-Drittauskunfts-Schranke (Cross-Ref MP_06).
...
1. **§ 28/1 S. 3 BaySchO** (verbatim, verified-1:1): „Sonntage, Feiertage und Ferien sind von Hausaufgaben freizuhalten." — drei Kategorien, kein Spielraum.
...
*[§ 28 BaySchO]: BaySchO § 28 — Hausaufgaben (Abs. 1+2 verified-1:1; Drei-Sätze-Logik in Abs. 1: Stellpflicht + LK-Konferenz-Grundsätze + Sonntage/Feiertage/Ferien frei)
*[§ 32 BaySchO]: BaySchO § 32 — Individuelle Unterstützung (verified-1:1; HA-Differenzierung in Abs. 2 Nr. 6)
...
*[Art. 56/2 BayEUG]: BayEUG Art. 56 Abs. 2 — SuS-Rechte (5 Punkte: Beteiligung · Mitwirkung · Information · Auskunft Leistungsstand · Beschwerde nacheinander LK → SL → Schulforum) (verified-1:1)
*[Art. 56 BayEUG]: BayEUG Art. 56 — SuS-Rechte und -Pflichten (Container; Abs. 2-5 verified-1:1, Abs. 1+6 partial-summary)
*[Art. 76 BayEUG]: BayEUG Art. 76 — Eltern-Mitwirkungspflicht (verified-1:1; „achten auf" + „unterstützen")
*[Art. 86 BayEUG]: BayEUG Art. 86 — Erziehungs- und Ordnungsmaßnahmen (Abs. 1+3 verified-1:1; Nacharbeit-Schlüsselsatz Abs. 1)
*[Art. 86/1 BayEUG]: BayEUG Art. 86 Abs. 1 — Erziehungsmaßnahmen + Subsidiarität + Verhältnismäßigkeit (verified-1:1; Nacharbeit „unter Aufsicht einer Lehrkraft")
*[Art. 75 BayEUG]: BayEUG Art. 75 — Unterrichtungspflicht ggü. EB (Anker; out-of-repo)
*[Art. 65 BayEUG]: BayEUG Art. 65 — Elternbeirat-Anhörung (Anker; out-of-repo)
*[Art. 64 BayEUG]: BayEUG Art. 64 — Elternbeirat-Aufgaben (Anker; out-of-repo)
*[Art. 57 BayEUG]: BayEUG Art. 57 — SL-Gesamtverantwortung (Anker; out-of-repo)
*[Art. 52 BayEUG]: BayEUG Art. 52 — LNW-Definition (Anker für HA ≠ LNW-Pfad)
*[Art. 88 BayEUG]: BayEUG Art. 88 — Verfahren bei Ordnungsmaßnahmen (Anker; out-of-repo) — Cross-Ref MP_01
*[§ 5 LDO]: LDO § 5 — Aufsichtspflicht (verified-1:1; Vollzitat siehe MP_06 A.2)
...
*[BayVwVfG Art. 28]: BayVwVfG Art. 28 — Anhörung im Verwaltungsverfahren (Anker; out-of-repo)
