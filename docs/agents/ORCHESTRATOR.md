...
1. **Qualitäts-Gate**: AGENT_QUALITAET bewertet mit Pass/Fail pro Prüfpunkt gemäß `docs/checklisten/Checkliste_Interaktive_Materialien.md`
...
|---|---|---|
| Didaktik | `docs/agents/AGENT_DIDAKTIK.md` | Lernziele, Kompetenzerwartungen, ethische Leitlinien |
| Inhalt | `docs/agents/AGENT_INHALT.md` | Sachanalyse, fachliche Korrektheit, Quellenarbeit |
| Material | `docs/agents/AGENT_MATERIAL.md` | Materialproduktion, JSON-Output |
| Rätsel | `docs/agents/AGENT_RAETSEL.md` | Aufgabendesign, Codes, Tipps, Narrativ |
| Technik | `docs/agents/AGENT_TECHNIK.md` | HTML/CSS/JS-Implementierung, Barrierefreiheit |
| Design | `docs/agents/AGENT_DESIGN.md` | Visuelles Theme, Responsive Design, UX |
| Qualität | `docs/agents/AGENT_QUALITAET.md` | Test, Review, Checklisten-Abarbeitung |
