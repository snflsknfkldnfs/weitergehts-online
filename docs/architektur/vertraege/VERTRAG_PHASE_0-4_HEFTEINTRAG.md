...
**Version:** v1.0 (Phase IV Architektur-Evaluation)
**Datum:** 2026-04-06
...
4. **SCPL-Struktur aufbauen:**
   ...
   - Complication[]: Problematisierende Schritte (min. 1, max. 4)
...
```json
{
  ...
  "scpl": {
    ...
    "complication": [
      { "schritt": "...", "erarbeitbarkeit": "DIRECT|ARTIFACT|INFERENTIAL" }
    ],
    "problem": { "satz": "..." },
    "loesung": [
...
| QH3 | SCPL-Struktur vollstaendig | Alle 4 Zonen (S, C[], P, L[]) vorhanden. Min. 1 Complication. Min. 1 Loesung. JSON-Schema valide. Knoten/Verbindungen als leere Arrays. | BLOCKER |
...
**Gate-Urteil:** PASS wenn alle BLOCKER bestanden + max 1 HIGH als WARN. Sonst: Nachbesserung (max. 1 Iteration, dann Finding dokumentieren).
