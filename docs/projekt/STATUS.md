...
- A3.1 HANDOFF-Korrektur + CC-Mini-Rerun — **PENDING** (nutzt Prevent-First-Gate + TEMPLATE als Dogfood)
...
**Naechster Schritt F0b:** (1) A3.1 HANDOFF-Korrektur (F-RA3-01 Lueckentext-Pool-Reset als realer Ticket-Text) + CC-Mini-Rerun — verpflichtend ueber tools/cc-launch-TEMPLATE.sh (Gate-Dogfood). (2) Nach A3.1-PASS: E2E-Pilot v3.12 mit Thema-Wahl LB2 (Absolutismus/Revolution, mittlere Trigger-Aktivierung) oder LB4 (Imperialismus/Kolonialismus, hohe Trigger-Aktivierung, Stress-Test Nicht-Dominant-Perspektiven + Blacklist). (3) F0b.3b Drift-Audit nach Pilot. (4) F0b.4 Close + Commit.
