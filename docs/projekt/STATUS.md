...
**Naechster Schritt:** AU-2a Scope gemaess `SESSION_13_MASTERPLAN.md` Schritte 6-14: (1) VERTRAG_ATOM_UNITS.md AU-2 → AU-2a/2b/2c splitten, (2) VERTRAG_FEEDBACK_SCHEMA.md Backfill-Generator-Spec-Sektion ergaenzen, (3) VERTRAG_PHASE_2-2b_AUFGABE.md Feedback-Pflichtfeld + A25/A26-Querverweis, (4) GUETEKRITERIEN_AUFGABEN.md A25 (Schema-Vollstaendigkeit) + A26 (Didaktische Feedback-Validitaet), (5) 7x SUB_AUFGABE_*.md Feedback-Schema-Block mandatory, (6) FEEDBACK_BACKFILL_MAPPEN_1_4.md Dispatch fuer 24 Alt-Aufgaben (Option B Hybrid-Pattern), (7) UEBERGABE_PHASE_IV_WAVE_1_AU_2a.md Cold-Handoff Claude-Code (Engine normalizeFeedback + data.json Backfill + Cache-Bust v=4.0→v=4.1), (8) Pre-Commit-Gate-3-Checks, (9) Commit-Block fuer User via Rahmen §2/§3. Danach AU-2a CLOSED, AU-2b Planung (STR-04 3-stufige Tipps, pro-Typ didaktisch-qualitative Evaluation).
