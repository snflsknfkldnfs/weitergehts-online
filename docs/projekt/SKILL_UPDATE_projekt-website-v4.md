---
name: projekt-website-v4
description: >
  Projektmanagement-Agent fuer interaktive Unterrichtsmaterialien als statische Website (GitHub Pages). v4-Produktionsarchitektur: Vertrags-Extraktion, Dispatch-Isolation, Session-Split, Uebergabe-Prompts, Post-Produktions-Qualitaetsreview. IMMER triggern bei: Website-Projekt, Escape-Game, GitHub Pages, Projektfortschritt, 'wo stehen wir', 'naechster Schritt', 'weitergehts.online', UPGRADE_PLAN, Cowork-Runde, Vertrag, Dispatch, Q-Gate, Mappe, Assembly, Qualitaetsbefund, Subagent, Uebergabe-Prompt. Auch bei loser Erwaehnung von Website-Entwicklung oder interaktiven Lernformaten. NICHT triggern bei TUV/Schriftwesen oder Stundenplanung ohne Website-Bezug.
---

# Projekt-Website: Interaktive Unterrichtsmaterialien (v4-Produktionsarchitektur)
...
### Zwei-Stufen-Architektur Sicherungskette (Audit Sicherungskette, ab 2026-04-02)

**STRUKTUR-FREEZE (Phase 0.4 — unveraenderlich):** SCPL-Zonen (Anzahl, Reihenfolge, Typ), Kernerkenntnisse/scpl.loesung[], Fachbegriffe, Ordnungsmuster, Stundenfrage. Keine Zone hinzufuegen/entfernen/umordnen.

**FORMULIERUNGS-OFFEN (bis Phase 2.1c Achse 6):** SCPL-Texte (situation.kontextsatz, complication[].schritt-Saetze, problem.satz). Sprachliche Verfeinerung an Material-Kontext erlaubt. Struktur-Elemente bleiben verboten.

**zusammenfassung/ueberleitung:** Werden in Phase 2.0 als Placeholder "[REVISION IN 2.1c]" gesetzt. Finale Produktion erst in Phase 2.1c Achse 6 (nach Materialien).

**SCPL-Schritt als Material-Input:** Phase 2.1 Read-Schritt 2 uebergibt neben tafelbild_knoten[] auch den zugehoerigen scpl{}-Schritt an jeden SUB_MATERIAL_*.

**MQ6 Erarbeitbarkeits-Plausibilitaet:** SOLL-Kriterium im Material-Q-Gate — Material muss SCPL-Schritt erarbeitbar machen, nicht nur formal abdecken (Audit M5/PF-13).
...
Phase 2: Didaktische Produktion (Cowork, isolierte Dispatches)
  ...
  2.1c Cross-Konsistenz + Ueberleitungen + Hefteintrag-Revision (1 Dispatch, 6 Achsen)
      Achsen 1-4: Sequenz-Kohaerenz, Fachbegriff-Konsistenz, Ueberleitung-Kohaerenz, TB-Knoten-Gesamtabdeckung
      Achse 5: Zwei-Vektoren-Ueberleitungen (backwards + forwards Vektor)
      Achse 6: Hefteintrag-Revision (FORMULIERUNGS-OFFEN → finale SCPL-Texte, zusammenfassung, ueberleitung)
  --- SESSION-SPLIT ---
...
- STRUKTUR-FREEZE / FORMULIERUNGS-OFFEN-Hinweis
