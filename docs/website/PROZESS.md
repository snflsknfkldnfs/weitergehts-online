...
| **E5 Akten-Look-Absorption (Theme+Engine)** | **⬅ IN ARBEIT seit 2026-07-25** — Spec freigegeben 2026-07-26 (+ Präzisierungen aus Plan-Exploration: Übersicht→Engine `initUebersicht`, Labels Migration-treu + Fix-Commit, dritte Label-Stelle `dossier_label`, Dark fix ohne Game-Light-Schalter); **Plan liegt vor** (`plans/2026-07-26-e5-akten-look-absorption.md`, 12 Tasks, **Review Paul ausstehend**) → Umsetzung in separater Dev-Session auf Branch `feat/e5-akten-look`; Leitplanke Distributions-Neutralität (Vertriebs-/Plattform-Frage bleibt offen, E5 verbaut nichts); fällig spätestens VOR dem nächsten neuen Game |
