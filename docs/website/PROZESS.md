...
| **E5 Akten-Look-Absorption (Theme+Engine)** | **⬅ IN ARBEIT seit 2026-07-25** — Spec liegt vor (`specs/2026-07-26-e5-akten-look-absorption-design.md`, **Review Paul ausstehend**); entschieden: reine Architektur-Migration, Syrien bleibt visuell regressions-frei (Vorher/Nachher-Abnahme); neu: Leitplanke Distributions-Neutralität (Vertriebs-/Plattform-Frage bleibt offen, E5 verbaut nichts); fällig spätestens VOR dem nächsten neuen Game |
