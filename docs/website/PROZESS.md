...
| **E5 Akten-Look-Absorption (Theme+Engine)** | **⬅ IN ARBEIT seit 2026-07-25** (Brainstorm) — entschieden: reine Architektur-Migration, Syrien bleibt visuell regressions-frei (Vorher/Nachher-Abnahme); Vorentscheidungen in E1-Spec §6; fällig spätestens VOR dem nächsten neuen Game |
