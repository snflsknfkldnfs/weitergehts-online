...
window.MODULE = {
  ...
  kurz: [
    ...
    '**Drei-Stufen-Logik OM** Art. 86: Erziehungsmaßnahmen (Art. 86/1, inkl. **Nacharbeit** S. 2) → Ordnungsmaßnahmen (Art. 86/2 = 12-Nr.-Katalog) → Sicherungsmaßnahmen (Art. 87). Subsidiarität + Verhältnismäßigkeit. Anhörung Art. 88 PFLICHT vorab. **Pos 10 erfordert 2/3-EB-Mehrheits-Sperre** (LK-Konferenz im Einvernehmen Schulaufsichtsbehörde).',
  ...
  pflichtwissen: [
    ...
    },
    {
      ...
      antwort: '(1) schriftlicher Verweis · (2) verschärfter Verweis · (3) Versetzung in eine Parallelklasse · (4) Nacharbeit unter Aufsicht (= zugleich Erziehungsmaßnahme nach Abs. 1 S. 2) · (5) Ausschluss vom Unterricht **bis 6 U.-Tage** (SL) · (6) Ausschluss **2-4 Wochen** (LK-Konferenz, bei schul. Gefährdung) · (7) Androhung der Entlassung · (8) Entlassung von der Schule · (9) Zuweisung zu einer anderen Klasse derselben Schule · **(10) Zuweisung an eine andere gleichartige Schule [LK-Konferenz im Einvernehmen Schulaufsichtsbehörde — sofern EB nicht mit 2/3-Mehrheit dagegen]** · (11) Entlassung an der Mittel-/Förder-/Berufsschule · (12) Ausschluss von allen Schulen der jeweiligen Schulart. **Verfahren**: Anhörung Art. 88 PFLICHT vorab. **Verbote Abs. 3**: körperl. Züchtigung · Kollektivstrafen · Strafarbeiten · entwürdigende Strafen. Abs. 3 Nr. 4: Pflichtschul-SuS vor Nr. 9-12 geschützt (Ausnahme Nr. 11).',
  ...
  faelle: [
    ...
    {
      id: 'F5',
      titel: 'Messer im Unterricht — 3-Phasen-Eskalation (Prüfer-Klassiker)',
      sachverhalt: 'In der Pause zeigt ein 13-jähriger Schüler einem Mitschüler ein Klappmesser („Schau, was ich da habe!"). Andere SuS rufen die LK. Die LK kommt dazu, das Messer wird ihr widerstandslos übergeben.',
      knackpunkte: [
        '**Phase 1 — Sofortmaßnahme** (Min 0-5): § 5 LDO + § 23 BaySchO Sicherstellung des Gegenstands (Messer). Art. 87 BayEUG vorläufiger Unterrichts-Ausschluss der PERSON, falls Wiederholungs-/Eskalationsgefahr. EB-Information unverzüglich. Polizei NUR bei akuter Gefahrenlage.',
        '**Phase 2 — Schulinternes Verfahren** (Tag 1-3): Art. 88 BayEUG Anhörung der SuS + EB. Klassenkonferenz-Beratung. Verhältnismäßigkeits-Prüfung. Art. 86/2 OM-Entscheidung — bei 13-Jährigem typ. Verweis (Nr. 1-2) bis Ausschluss 6 U.-Tage (Nr. 5, SL).',
        '**Phase 3 — Strafrechtliche Schnittstelle** (Tag 0-7): § 158 StPO Strafanzeige liegt im Ermessen der SL. § 224 StGB gefährliche Körperverletzung (mit Waffe) NUR bei Verletzung. § 241 StGB Bedrohung wenn explizit gedroht. Bei 13-Jährigem: **Strafmündigkeit NICHT** erreicht (§ 1 JGG: ab Vollendung 14. Lj.) → Jugendamt § 8a SGB VIII parallel statt JGG-Verfahren.',
        '**Sicherheits-Anker bei 14+ J.**: bei strafmündigen SuS Polizei + Jugendgerichtsverfahren möglich. Schulisches OM-Verfahren läuft parallel + unabhängig (ne bis in idem GILT NICHT — Art. 103/3 GG nur „allgemeine Strafgesetze", → Cross-Ref mp05 A.5).',
      ],
      antwortkette: 'Phase 1: § 23 BaySchO Messer-Sicherstellung + Art. 87 BayEUG Person-Ausschluss bei Eskalationsgefahr + EB-Info → Phase 2: Art. 88 Anhörung + Verhältnismäßigkeit + Art. 86/2 OM (Verweis bis 6-U.-Tage-Ausschluss) → Phase 3: § 158 StPO Anzeige durch SL nach Ermessen; bei <14 § 8a SGB VIII Jugendamt; bei ≥14 §§ 224/241 StGB + JGG.',
    },
  ],
  ...
  glossar: {
    ...
    'Art. 86 BayEUG': { titel: 'Art. 86 BayEUG — Erziehungs- + Ordnungsmaßnahmen', wortlaut: 'Abs. 1: „Zur Sicherung des Bildungs- und Erziehungsauftrags oder zum Schutz von Personen und Sachen können Erziehungsmaßnahmen gegenüber Schülerinnen und Schülern getroffen werden. ²Dazu zählt bei nicht hinreichender Beteiligung der SuS am Unterricht auch eine **Nacharbeit unter Aufsicht** einer Lehrkraft. ³Soweit andere Erziehungsmaßnahmen nicht ausreichen, können Ordnungs- und Sicherungsmaßnahmen ergriffen werden." (Nacharbeit ist Doppel-Anker: primär Erziehungsmaßn. Art. 86/1 S. 2 + zugleich als OM Art. 86/2 Nr. 4 gelistet.) **Abs. 2: 12-Nr.-OM-Katalog**: (1) schriftl. Verweis · (2) verschärfter Verweis · (3) Versetzung in Parallelklasse · (4) Nacharbeit unter Aufsicht · (5) Ausschluss vom U. bis 6 U.-Tage [SL] · (6) Ausschluss 2-4 Wochen [LK-Konferenz, bei schul. Gefährdung] · (7) Androhung der Entlassung · (8) Entlassung von der Schule · (9) Zuweisung zu anderer Klasse derselben Schule · (10) Zuweisung an andere gleichartige Schule **[LK-Konferenz im Einvernehmen Schulaufsichtsbehörde — sofern EB nicht mit 2/3-Mehrheit dagegen]** · (11) Entlassung MS/FöS/BS · (12) Ausschluss aller Schulen derselben Art [Staatsministerium]. Abs. 3: Verbote körperl. Züchtigung · Kollektivstrafen · Strafarbeiten · entwürdigende Strafen. **Abs. 3 Nr. 4: Pflicht-Schüler-Schutz vor Nr. 9-12** (Ausnahme Nr. 11 bei MS/FöS/BS mit qualifiziertem Sachverhalt).', karten: ['B03', 'B04'] },
